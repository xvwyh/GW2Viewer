...
struct Token32 : TypeInfo::SymbolType
{
    ...
    [[nodiscard]] static auto GetDecoded(byte const* data) { return ((pf::Token32 const*)data)->GetString(); }
...
struct Token64 : TypeInfo::SymbolType
{
    ...
    [[nodiscard]] static auto GetDecoded(byte const* data) { return ((pf::Token64 const*)data)->GetString(); }
...
struct ArrayT : TypeInfo::SymbolType
{
    ...
    [[nodiscard]] std::optional<TypeInfo::Condition::ValueType> GetValueForCondition(byte const* data) const override { return *(uintptr_t const*)data; }
    [[nodiscard]] std::string GetDisplayText(byte const* data) const override { return { }; }
...
{
    static TypeInfo::SymbolType const* instance[]
    {
